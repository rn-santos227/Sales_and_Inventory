		...
		<form class="form-horizontal">
			<div class="panel panel-success" style="border-color: #8eb4cb;">
	      		...
	      		<div class="panel-body clearfix" >
	      			<center>
			        <a href="{{ route('menus-file',['type'=>'xls']) }}"><button type="button" style="width: 200px" class="btn btn-md btn-success">Download Excel xls</button></a> <br><br>
			        <a href="{{ route('menus-file',['type'=>'xlsx']) }}"><button type="button"style="width: 200px" class="btn btn-md btn-success">Download Excel xlsx</button></a> <br><br>
			        <a href="{{ route('menus-file',['type'=>'csv']) }}"><button type="button" style="width: 200px" class="btn btn-md btn-success">Download CSV</button></a>
			        </center>
	      		</div>
