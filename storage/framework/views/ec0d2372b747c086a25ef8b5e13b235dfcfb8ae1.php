    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <br>
                    <a href="<?php echo e(route('salesreports/salesactivities/pdf',['download'=>'pdf'])); ?>" class="pull-left"><i class="fa fa-file-pdf-o" aria-hidden="true" target="_blank"></i> Download PDF</a>
