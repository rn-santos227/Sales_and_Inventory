	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a href="<?php echo e(route('promos/pdf',['download'=>'pdf'])); ?>" class="pull-left"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF</a>&nbsp;
                    <a href="fileentry/dload/php85C0.tmp.xlsx"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel Template</a>
				<div id="product_container">
				<!-- promos Table -->
				<?php echo $__env->make('promos.data', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>
	</div>
...
<!-- Child Views -->
<?php echo $__env->make('promos.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('promos.view', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('promos.update', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php echo e(asset('js/promo-script.js')); ?>" type="text/javascript"></script>
