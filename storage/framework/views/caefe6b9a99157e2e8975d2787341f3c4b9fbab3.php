                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <button style="width: 100%; border-color: <?php echo e(App\Theme::all()->first()->tertiary); ?>; background-color: <?php echo e(App\Theme::all()->first()->tertiary); ?>;" type="submit" class="btn btn-primary">
                                                Log In
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group item_hide">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a class="btn btn-link pull-right item_hide" style="color: <?php echo e(App\Theme::all()->first()->tertiary); ?>;" href="<?php echo e(route('password.request')); ?>">
