    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="<?php echo e(route('suppliers/pdf',['download'=>'pdf'])); ?>" class="pull-left"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF</a>                    
                    <div id="product_container">&nbsp;
                        <a href="fileentry/dload/php21E1.tmp.xlsx"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel Template</a>
                        <?php echo $__env->make('suppliers.data', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <center>
...
<!-- Child Views -->
<?php echo $__env->make('suppliers.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('suppliers.view', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('suppliers.update', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php echo e(asset('js/supplier-script.js')); ?>" type="text/javascript"></script>
