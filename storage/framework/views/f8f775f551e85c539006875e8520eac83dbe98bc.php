	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a href="<?php echo e(route('discounts/pdf',['download'=>'pdf'])); ?>" class="pull-left"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF</a>&nbsp;
                    <a href="fileentry/dload/phpFD7E.tmp.xlsx"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel Template</a>
				<div id="product_container">
				<!-- Discounts Table -->
				<?php echo $__env->make('discounts.data', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>
	</div>
...
<!-- Child Views -->
<?php echo $__env->make('discounts.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('discounts.view', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('discounts.update', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php echo e(asset('js/discount-script.js')); ?>" type="text/javascript"></script>
