	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a href="<?php echo e(route('employees/pdf',['download'=>'pdf'])); ?>" class="pull-left"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF</a>&nbsp;
                    <a href="fileentry/dload/phpACD2.tmp.xlsx"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel Template</a>
				<div id="product_container">
				<!-- employees Table -->
				<?php echo $__env->make('employees.data', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>
	</div>
...
<!-- Child Views -->
<?php echo $__env->make('employees.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('employees.view', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('employees.update', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php echo e(asset('js/employee-script.js')); ?>" type="text/javascript"></script>
