    ...
    <tbody>
   		...
   		<tr id="order<?php echo e($cart->id); ?>">
            ...
            <td>
            	...
            	<input class="txt_quantity" type="number" min="1" max="<?php echo e($cart->max); ?>" value="<?php echo e($cart->quantity); ?>" id="count<?php echo e($cart->id); ?>" style="width:40px;">
			...
			<td align="center">
				<form>
          <input type="hidden" name="order_price<?php echo e($cart->id); ?>" value="<?php echo e($cart->price); ?>">
