	            ...
	            <?php echo e(csrf_field()); ?>
			 	...
			 	<div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <div class="accordion">
                                <div class="accordion-section">
                                    <a class="accordion-section-title" data-accordion="#accordion-2"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Receipt Information </a>
                                    <div id="accordion-2" class="accordion-section-content">
                                    <?php echo $__env->make('restaurant.receipt', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="accordion">
                                <div class="accordion-section">
                                    ...
                                    <?php echo $__env->make('restaurant.promo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group<?php echo e($errors->has('change_due') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-8">
                            <input id="cashier-change_due" type="number" min="1" class="form-control" name="change_due" readonly style="background-color:#ffffff;">
                        </div>
                    </div>
                <!-- end panel body -->  
			 	</div>
