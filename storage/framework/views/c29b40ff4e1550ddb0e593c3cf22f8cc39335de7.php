<form class="form-horizontal">
               ...
               <div class = "input-group-btn">
                    <!-- <input id="btn_discount" type="text" class="form-control" name="customer_name" required autofocus list="discounts"  style="width: 100px">
                        <datalist id="discounts">
                            ...
                            <option value="<?php echo e($discount->rate); ?>" class="compute_discount" ><?php echo e($discount->ref_code); ?></option>
    ...
    <div class="form-group<?php echo e($errors->has('service_charge') ? ' has-error' : ''); ?>">
