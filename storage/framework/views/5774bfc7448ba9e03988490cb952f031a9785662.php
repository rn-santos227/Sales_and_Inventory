            	...
            	<div class="row">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body" style="overflow: scroll; overflow-x: hidden; height:80vh; background-color: #f7f7f7;">
								<form style="margin-bottom: 10%;">
									<?php echo $__env->make('restaurant.menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
								</form>
					...
					<div class="col-md-5">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h4>Pending</h4>
								<?php echo $__env->make('restaurant.tray', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
								<br>
								<h4>Served</h4>
								<?php echo $__env->make('restaurant.serve', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
							</div>	
